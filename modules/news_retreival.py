...
from constants import PERPLEXITY_API_KEY, PERPLEXITY_ONLINE_MODEL , PERPLEXITY_ONLINE_MODEL_SYSTEM_PROMPT, PERPLEXITY_ONLINE_MODEL_HUMAN_PROMPT, CRYPTO_INDUSTRY, AI_INDUSTRY
import os
